...
local pingTimer = ctx.interval(30)
...
while healthyWire do
  ...
  local notifKeys = {}
  for key in pairs(notifs) do
    table.insert(notifKeys, key)
  end
  ctx.log("ctx.poll() included", len(notifs), "notifs:", notifKeys)
